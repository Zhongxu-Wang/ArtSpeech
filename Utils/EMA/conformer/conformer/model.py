...
class Conformer(nn.Module):
    ...
    def __init__(
            ...
            feed_forward_dropout_p: float = 0.05,
            attention_dropout_p: float = 0.05,
            conv_dropout_p: float = 0.05,
    ...
    def forward(self, inputs: Tensor, input_lengths: Tensor, ph_embedding: Tensor) -> Tuple[Tensor, Tensor, Tensor]:
        """
        ...
        """
        encoder_outputs, encoder_output_lengths = self.encoder(inputs, input_lengths, ph_embedding)
